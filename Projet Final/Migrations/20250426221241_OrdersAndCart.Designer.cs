...
namespace Projet_Final.Migrations
{
    ...
    [Migration("20250426221241_OrdersAndCart")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Projet_Final.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Projet_Final.Models.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Projet_Final.Models.ShoppingCartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Projet_Final.Models.OrderItem", b =>
                {
                    b.HasOne("Projet_Final.Models.Furniture", "Furniture")
                        .WithMany()
                        .HasForeignKey("FurnitureId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Projet_Final.Models.Order", "Order")
                        .WithMany("OrderItems")
